    ...
    if gameStarted then
        ...
        for name in next, players do
            ...
            if players[name].playing then
                if mapPlaying == 2 then
                    local i = math.random(#spawnPoints[1])
                    tfm.exec.movePlayer(name, spawnPoints[1][i].x, spawnPoints[1][i].y, false, 0, 0, false)
                elseif mapPlaying == 3 then
                    local i = math.random(#spawnPoints[2])
                    tfm.exec.movePlayer(name, spawnPoints[2][i].x, spawnPoints[2][i].y, false, 0, 0, false)
                end
            end
        end
    else
