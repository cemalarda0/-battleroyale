...
addBonusImg = function(event, name)
    ...
    elseif event == 4 or event == 5 then
        players[name].event.img = tfm.exec.addImage("165df84aad8.png", "&100", 765, 363, name, 1, 1, math.rad(0), 1,
                                      0.5, 0.5)
        ui.addTextArea(textAreaIds.gift.onImg, "\n\n<p align ='right'><font color ='#ff0000'>"..players[name].obj.count.."</font></p>", name, 740, 348, 50, 50, nil, nil, 0, true)
    end
end
