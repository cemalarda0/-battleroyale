    ...
    if players[name].playing and key == 32 then
        if players[name].cooldown == 0 then
            ...
            if players[name][3] == 0 or players[name][3] == 2 then
                players[name].lastObj = tfm.exec.addShamanObject(players[name].obj.id, players[name][3] == 0 and x - players[name].obj.offset or x + players[name].obj.offset, y,
                                            players[name][3] == 0 and -90 or 90)
            else
                players[name].lastObj = tfm.exec.addShamanObject(players[name].obj.id, x, players[name][3] == 1 and y - players[name].obj.offset or y + players[name].obj.offset,
